...
<head>
  <meta charset="UTF-8">
  <title>Dry Fruits | EBC Grocery</title>
...
<div class="container py-5">
  ...
  <h3 class="mb-4 text-center">Available Dry Fruits</h3>

  <div class="row g-4">
    <?php
      $sql = "SELECT * FROM dryfruit";
    ...
    <?php
        ...
        echo "<div class='col-12'><p class='text-danger text-center'>No dry fruits available at the moment.</p></div>";
      endif;
    ?>
  </div>
</div>
