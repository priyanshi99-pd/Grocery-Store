...
<head>
  <meta charset="UTF-8">
  <title>Bakery | EBC Grocery</title>
...
<body>
    <?php include "C:/xamp1/htdocs/grocery_1/grocery/header.php"; ?>
<div class="container py-5">
  <div class="d-flex justify-content-between align-items-center mb-4">
    <h2 class="mb-0">Welcome, <span style="color:#2d6a4f"><?= htmlspecialchars($cuname) ?></span> 🍞</h2>
  </div>

  <h3 class="mb-4 text-center">Available Fresh Bakery Items</h3>
  ...
  <div class="row g-4">
    ...
    <?php
        ...
        echo "<div class='col-12'><p class='text-danger text-center'>No bakery items found in stock.</p></div>";
      endif;
    ?>
  </div>
</div>
