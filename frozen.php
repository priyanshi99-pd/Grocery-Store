...
<head>
  <meta charset="UTF-8">
  <title>Frozen Products | EBC Grocery</title>
...
<div class="container py-5">
  ...
  <h3 class="mb-4 text-center">Available Frozen Products</h3>

  <div class="row g-4">
    <?php
      $sql = "SELECT * FROM frozen";
    ...
    <?php
        ...
        echo "<div class='col-12'><p class='text-danger text-center'>No frozen products found in stock.</p></div>";
      endif;
    ?>
  </div>
</div>
