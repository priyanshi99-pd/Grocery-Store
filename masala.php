...
<head>
  <meta charset="UTF-8">
  <title>Masala | EBC Grocery</title>
...
<div class="container py-5">
  <div class="d-flex justify-content-between align-items-center mb-4">
    <h2 class="mb-0">Welcome, <span style="color:#2d6a4f"><?= htmlspecialchars($cuname) ?></span> 🌶️</h2>
  </div>

  <h3 class="mb-4 text-center">Explore Our Masala Collection</h3>
  ...
  <div class="row g-4">
    ...
    ?>
      <div class="col-md-4">
        <div class="product-card">
          ...
          <p>Price: ₹<?= htmlspecialchars($product['price']) ?>/kg</p>
    ...
    <?php
        ...
        echo "<div class='col-12'><p class='text-danger text-center'>No masala items available at the moment.</p></div>";
      endif;
    ?>
  </div>
</div>
