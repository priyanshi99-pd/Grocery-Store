...
$category = "vegetables"; // used for table name
?>
...
<head>
  <meta charset="UTF-8">
  <title>Vegetables | EBC Grocery</title>
...
<body>
  ...
  <div class="container py-5">
    ...
    <h3 class="mb-4 text-center">Available Fresh Vegetables</h3>
    ...
    <div class="row g-4">
      ...
      <?php
          ...
          echo "<div class='col-12'><p class='text-danger'>No vegetables found in stock.</p></div>";
        endif;
      ?>
    </div>
  </div>
