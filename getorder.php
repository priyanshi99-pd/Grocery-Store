    ...
    <div class=row>
        ...
        <div class="col-8" id=frmData >
            <?php
                ...
                $bno=$_GET['bno'];
                $res=mysqli_query($conn," select bill.bill_no,product.pid,pname,pprice,pqty from product,short_bill,bill where short_bill.billno=bill.bill_no and ostatus='Ordered' and short_bill.pid=product.pid and bill.bill_no=$bno");
                ?>
