...
<head>
  <meta charset="UTF-8">
  <title>Fruits | EBC Grocery</title>
...
<div class="container py-5">
  ...
  <h3 class="mb-4 text-center">Fresh Fruits Available</h3>
  ...
  <div class="row g-4">
    ...
    <?php
        ...
        echo "<div class='col-12'><p class='text-danger text-center'>No fruits available in stock.</p></div>";
      endif;
    ?>
  </div>
</div>
