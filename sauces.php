...
<head>
  <meta charset="UTF-8">
  <title>Sauces | EBC Grocery</title>
...
<div class="container py-5">
  ...
  <h3 class="mb-4 text-center">Delicious Sauces for Every Dish</h3>
  ...
  <div class="row g-4">
    ...
    <?php
        ...
        echo "<div class='col-12'><p class='text-danger text-center'>No sauces available right now.</p></div>";
      endif;
    ?>
  </div>
</div>
