...
<head>
  <meta charset="UTF-8">
  <title>Beverages | EBC Grocery</title>
...
<div class="container py-5">
  ...
  <h3 class="mb-4 text-center">Available Refreshing Beverages</h3>
  ...
  <div class="row g-4">
    ...
    ?>
      <div class="col-md-4">
        <div class="product-card">
          ...
          <p>Price: ₹<?= htmlspecialchars($product['price']) ?>/ltr</p>
    ...
    <?php
        ...
        echo "<div class='col-12'><p class='text-danger text-center'>No beverages found in stock.</p></div>";
      endif;
    ?>
  </div>
</div>
