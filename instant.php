...
<head>
  <meta charset="UTF-8">
  <title>Instant Food | EBC Grocery</title>
...
<div class="container py-5">
  ...
  <h3 class="mb-4 text-center">Quick & Tasty Instant Foods</h3>
  ...
  <div class="row g-4">
    ...
    <?php
        ...
        echo "<div class='col-12'><p class='text-danger text-center'>No instant products available right now.</p></div>";
      endif;
    ?>
  </div>
</div>
