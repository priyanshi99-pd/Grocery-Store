...
<head>
  <meta charset="UTF-8">
  <title>Ice Cream | EBC Grocery</title>
...
<div class="container py-5">
  ...
  <h3 class="mb-4 text-center">Chill With Delicious Ice Creams</h3>
  ...
  <div class="row g-4">
    ...
    <?php
        ...
        echo "<div class='col-12'><p class='text-danger text-center'>No ice creams available right now.</p></div>";
      endif;
    ?>
  </div>
</div>
