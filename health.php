...
<head>
  <meta charset="UTF-8">
  <title>Health | EBC Grocery</title>
...
<div class="container py-5">
  ...
  <h3 class="mb-4 text-center">Health & Wellness Products</h3>
  ...
  <div class="row g-4">
    ...
    <?php
        ...
        echo "<div class='col-12'><p class='text-danger text-center'>No health products available in stock.</p></div>";
      endif;
    ?>
  </div>
</div>
